...
{   
    public class AlphaBetaBoard
    {
        ...
        #region Initialize
        public AlphaBetaBoard(Panel gameboard, PictureBox player, int depth)
        {
...
/*        private long[] ArrayPointAttack = new long[7] { 0, 9, 54, 169, 1458, 12345, 140299 };
        ...
        public Point FindChess(List<List<Button>> Board)
        {
            ...
            int score = AlphaBeta(Depth, Board, Int32.MinValue, Int32.MaxValue, true);
            /*int score = AlphaBetaNewVS(Depth, Board, Int32.MinValue, Int32.MaxValue, true);*/
